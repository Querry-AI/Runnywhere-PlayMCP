...
# A landmark is an area, not a point, and several of these sat on a node the
# pedestrian graph cannot close a loop from -- 남산 on the summit, 여의도 mid-
# island, 망원·선유도 on a riverside spur. Every distance failed with "순환
# 코스를 만들지 못했어요". Each is moved to the nearest point that builds all
...
GAZETTEER: dict[str, tuple[float, float]] = {
    ...
    "하늘공원": (37.5710, 126.8830), "선유도공원": (37.5411, 126.8966),
    "어린이대공원": (37.5464, 127.0802), "용산가족공원": (37.5220, 126.9790),
    ...
    "여의도": (37.5232, 126.9245), "성수": (37.5446, 127.0559),
    ...
    "테헤란로8길8": (37.4991, 127.0290),
    "테헤란로8길": (37.4991, 127.0290),
    "강남구테헤란로8길8": (37.4991, 127.0290),
    "서울특별시강남구테헤란로8길8": (37.4991, 127.0290),
}
